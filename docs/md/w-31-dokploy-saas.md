...
Панель проектов (много приложений внутри проектов) в Dokploy:
...
Панель проекта (внутри одного проекта приложения) в Dokploy:
...
2. **Мониторинг и управление**  
   - В реальном времени видим логи приложения, нагрузку на CPU/RAM (всего сервера), статус контейнера
